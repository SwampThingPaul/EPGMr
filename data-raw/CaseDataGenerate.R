...
casedat<-data.frame(case.number=1:12,
                      ...
                      Soil.BulkDensity.inital=c(0.080,0.179,0.197,0.222,0.071,0.176,0.197,0.232,0.080,0.071,0.102,0.102),
                      Soil.TPConc.inital=c(500,463,508,467,366,358,376,330,442,366,198,198),
                      Vertical.SoilTPGradient.inital=c(-0.0018,-0.0039,-0.0052,-0.0054,-0.0018,-0.0039,-0.0052,-0.0054,-0.0018,-0.0018,-0.0018,-0.0018),
