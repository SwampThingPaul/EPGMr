...
```{r distance profile plot, echo=FALSE, fig.width=8,fig.height=5,fig.align='center',fig.cap="Distance profile for Case 11 (i.e. S10s) at the end of the 30 year simulation period."}
EPGMProfile(case.no=11,plot.profile=T)
```
